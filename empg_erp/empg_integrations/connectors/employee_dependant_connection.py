...
class EmployeeDependantConnection(BaseConnection):
	...
	def get(self, remote_objectname, fields=None, filters=None, start=0, page_length=10):
		...
		query = ("""
			SELECT 
                ...
                'employee_dependents' as parentfield,
                'Employee' as parenttype,
                edd.dependent_name as dependant_name,
                edd.dependent_relation as dependant_relation,
                edd.dependent_dob as dependant_dob
            FROM
                main_empdependencydetails edd
                    INNER JOIN
